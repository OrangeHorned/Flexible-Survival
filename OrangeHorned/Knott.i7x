...
say "     Start of conversation.";
	...
	[]
	if HP of Giving is 2:  [This line adds the quest option only if HP is 2]
		choose a blank row in table of fucking options;
	...
	repeat with y running from 1 to number of filled rows in table of fucking options: [Lines 252 through 265 are part of the menu. You don't change anything about these.]
...
to say KnottTalk4:
	...
	say "     Givings chuckle of embarrassment restores a bit of hope you have in this apocalypse, you hope things get better for the commune.";




instead of fucking Knott:	[Same as conversing, but works when the player says "Fuck Knott" in Knott's presence.]
	if (lastfuck of KnottFirbolg - turns < 6):
